...
const Navbar = () => (
  <div className="navbarbg">
    <div className="navbar-1">
      <h1 className="brand-logo">TANN TRIM</h1>
      <img
        alt="icons"
        src="https://res.cloudinary.com/dvzlfmmcb/image/upload/v1713057433/Group_327search_icons_u1hl3s.png"
      />
    </div>
    <div className="navbar-2">
      <p className="links">Bags</p>
      <p className="links">Travel</p>
      <p className="links">Accessories</p>
      <p className="links">Gifting</p>
      <p className="links">Jewelery</p>
    </div>
